...
def start():
	global x1,y1,score,lost,game,finish
	mixer.init()
	font.init()
	...
	for i in range(2):
		enemy = Enemy('bin/monster2.png',randint(50,970),10,randint(4,7))
		monsters.add(enemy)
	...
	while game:
		...
		if finish != True:
			...
			if score == 60:
				win = font2.render("ВЫ ВЫИГРАЛИ",True,(255,0,0))
				#win3 = font2.render("Нажмите Enter что бы продолжить.",True,(255,0,0))
